...
<div class="course-hub-header container-fluid px-4">
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-2">
                    <li class="breadcrumb-item"><a href="/onlinecourse/index.php?controller=course&action=instructor_courses" class="text-decoration-none">Khóa học của tôi</a></li>
    ...
    <ul class="nav nav-tabs nav-tabs-google">
        ...
        <li class="nav-item">
            <a class="nav-link" href="/onlinecourse/index.php?controller=enrollment&action=instructor_enrollment&course_id=<?= $course['id'] ?>">Học viên (Students)</a>
        </li>
    </ul>
</div>
