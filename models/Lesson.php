...
class Lesson {
    ...
    // Khai báo đầy đủ thuộc tính (Cần thiết cho chức năng Create/Update của Instructor)
    public $id;
    public $courseId;
    public $title;
    public $content;
    ...
    // =================================================================
    // PHẦN 1: READ METHODS (Dùng chung cho cả Student & Instructor)
    // =================================================================

    // Lấy danh sách bài học theo khóa học (Dùng cho Sidebar)
    ...
    // Lấy tài liệu của bài học (Giữ lại hàm này để View của bạn không bị lỗi)
    ...
    // =================================================================
    // PHẦN 2: INSTRUCTOR MANAGE METHODS (CRUD - Thêm/Sửa/Xóa)
    // =================================================================
